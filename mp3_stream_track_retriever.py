...
def get_track_info(station_url: str):
    """
    Gets the currently playing track on Generic MP3 Radio stream.
    ...
    try:
        ...
        # Make the request
        response = session.get(station_url, headers=headers, stream=True, verify=False, timeout=10)
...
if __name__ == "__main__":
    print("Now Playing:", get_track_info())